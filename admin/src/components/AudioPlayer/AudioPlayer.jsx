    ...
    return (
        ...
        <div className={`audio-player ${itemClass}`}>
            ...
            <div className="audio-player-timeline">
                ...
                <input ref={timelineRef} defaultValue="0" type="range" onMouseDownCapture={onDragStart} onClick={onDragEnd} className="audio-player-timeline__input" onChange={timelineHandler}/>
